...
export default function LoginPage() {
  ...
  // 🔥 New state to toggle between Login and Reset Password views
  ...
  const handleResetPassword = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Optional: switch back to login view after a delay
        ...
        <div className="bg-neutral-900/50 border border-neutral-800/60 backdrop-blur-xl rounded-3xl p-8 shadow-2xl space-y-5">
          ...
          {!isResetting ? (
            ...
            <form onSubmit={handleResetPassword} className="space-y-4">
              ...
              <button type="submit" disabled={loading || !email} className="w-full bg-amber-500 hover:bg-amber-400 disabled:bg-neutral-800 disabled:text-neutral-500 text-black py-3.5 rounded-2xl font-bold transition-colors mt-2">
