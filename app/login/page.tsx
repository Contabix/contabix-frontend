        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-neutral-500 mt-2 text-sm">
            {isResetting
              ...
              : "Sign in to your Contabix dashboard"}
          </p>
        </div>
            ...
            <>
              ...
              <form onSubmit={handleEmailLogin} className="space-y-4">
                ...
                <button
                  ...
                  className="w-full bg-amber-500 hover:bg-amber-400 disabled:bg-neutral-800 disabled:text-neutral-500 text-black py-3.5 rounded-2xl font-bold transition-colors mt-2"
                >
            ...
            <>
              ...
              >
                ...
                <button
                  ...
                  className="w-full text-neutral-400 hover:text-white transition-colors py-2 text-sm mt-2"
                >
                  Back to Login
                </button>
              </form>
